...
router
  .route('/')
  .post(auth('manageAdmin'), validate(userValidation.createUser), userController.createUser)
  .get(auth('manageAdmin'), validate(userValidation.getUsers), userController.getUsers);
 ...
 *     description: Only admins can accpet  users.
 *     tags: [Users]
 *     security:
 *       - bearerAuth: []
 *     requestBody:
